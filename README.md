...
- [zenith](https://github.com/zenith-editor/zenith): text editor written in zig (unmaintained, may not work with current zig version)
- [cloud](https://codeberg.org/g2mt/cloud): experimental successor to the C preprocessor (prototype)
